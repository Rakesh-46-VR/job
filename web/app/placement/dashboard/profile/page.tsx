...
export default function ProfilePage() {
    return (
        <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in duration-500">
            <h1 className="text-2xl sm:text-3xl font-bold font-serif text-foreground text-center">My Profile</h1>

            <div className="bg-card p-4 sm:p-6 md:p-8 rounded-xl shadow-lg border border-border">
                <div className="flex flex-col items-center mb-6 sm:mb-8">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-primary/10 flex items-center justify-center text-primary text-2xl sm:text-3xl font-bold mb-4 border-2 border-primary/20">
                        JD
                    </div>
                    <h2 className="text-xl sm:text-2xl font-bold text-foreground">John Doe</h2>
                    <p className="text-sm sm:text-base text-muted-foreground">Aspiring Full Stack Engineer</p>
                </div>

                <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-background rounded-lg border border-border hover:bg-secondary/10 transition-colors">
