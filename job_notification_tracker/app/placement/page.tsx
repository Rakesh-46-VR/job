...
export default function PlacementLandingPage() {
    return (
        <div className="min-h-screen flex flex-col font-sans bg-background text-foreground">
            {/* Hero Section */}
            <section className="flex-1 flex flex-col justify-center items-center text-center px-6 py-24 bg-background">
                <div className="max-w-4xl mx-auto space-y-8">
                    <h1 className="text-5xl md:text-6xl font-bold font-serif text-foreground tracking-tight">
                        Ace Your Placement
                    </h1>
                    ...
                    <div className="pt-4">
                        <Link
                            ...
                            className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white rounded-lg text-lg font-semibold hover:brightness-110 transition-all shadow-lg"
                        >
            ...
            <section className="py-24 px-6 bg-card border-y border-border">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {/* Feature 1 */}
                        <div className="p-8 rounded-xl bg-background border border-border hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-2xl font-bold font-serif mb-4 text-foreground">Practice Problems</h3>
                        ...
                        <div className="p-8 rounded-xl bg-background border border-border hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-2xl font-bold font-serif mb-4 text-foreground">Mock Interviews</h3>
                            <p className="text-muted-foreground">
                        ...
                        <div className="p-8 rounded-xl bg-background border border-border hover:shadow-md transition-shadow group">
                            ...
                            <h3 className="text-2xl font-bold font-serif mb-4 text-foreground">Track Progress</h3>
                            <p className="text-muted-foreground">
